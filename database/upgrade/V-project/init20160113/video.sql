...
CREATE TABLE `video_anchor` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=331 DEFAULT CHARSET=utf8 COMMENT='主播中心表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `video_complaints` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='用户投诉建议表**创建者：morgan';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `video_exit_room` (
  ...
  `created` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=20772 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `video_host_audit` (
  ...
  PRIMARY KEY (`auid`)
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8 COMMENT='主播申请记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `video_mail` (
  ...
  `mail_type` smallint(2) DEFAULT '0' COMMENT '业务类别',
  PRIMARY KEY (`id`),
  KEY ` category` (`category`)
) ENGINE=InnoDB AUTO_INCREMENT=328707 DEFAULT CHARSET=utf8 COMMENT='私信表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `video_online` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=70024 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `video_recharge` (
  ...
  `pay_status` smallint(2) NOT NULL DEFAULT '1',
...
CREATE TABLE `video_song_info` (
  ...
  `created` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='主播歌单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=44 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='用户邀请注册记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-01-08 23:06:35
-- MySQL dump 10.15  Distrib 10.0.12-MariaDB, for Linux (x86_64)
--
-- Host: localhost    Database: video
-- ------------------------------------------------------
...
INSERT INTO `video_level_exp` VALUES (1,'1星','美女',10000,0,0,0,0,40),(2,'2星','美女',30000,0,0,0,0,40),(3,'3星','美女',60000,1,0,0,0,40),(4,'4星','美女',100000,1,0,0,0,40),(5,'5星','美女',150000,1,0,0,0,40),(6,'1钻','明星',250000,1,1,1,0,45),(7,'2钻','明星',400000,1,1,1,0,45),(8,'3钻','明星',600000,1,1,1,1,45),(9,'4钻','明星',850000,1,1,1,1,45),(10,'5钻','明星',1150000,1,1,1,1,45),(11,'1皇冠','传奇',1550000,1,1,1,1,50),(12,'2皇冠','传奇',2050000,1,1,1,1,50),(13,'3皇冠','传奇',2650000,1,1,1,1,50),(14,'4皇冠','传奇',3350000,1,1,1,1,NULL);
...
INSERT INTO `video_level_rich` VALUES (1,'屌丝',0),(2,'一富',1000),(3,'二富',3000),(4,'三富',6000),(5,'四富',10000),(6,'五富',15000),(7,'六富',21000),(8,'七富',28000),(9,'八富',36000),(10,'九富',45000),(11,'十富',58000),(12,'男爵',75000),(13,'子爵',96000),(14,'伯爵',121000),(15,'候爵',150000),(16,'公爵',183000),(17,'郡公',220000),(18,'国公',261000),(19,'王爵',306000),(20,'藩王',359000),(21,'郡王',420000),(22,'亲王',489000),(23,'国王',566000),(24,'帝王',651000),(25,'皇帝',744000),(26,'天君',845000),(27,'帝君',954000),(28,'圣君',1071000);
...
INSERT INTO `video_goods` VALUES (120001,'私人直升机（月）',20000,'坐骑','坐骑',1002,2),(120003,'八抬大轿（月）',2000,'坐骑','坐骑',1002,2),(120004,'兰博基尼（月）',10000,'坐骑','坐骑',1002,2),(120006,'奥迪A8（月）',8000,'坐骑','坐骑',1002,2),(120007,'哈雷摩托（月）',4000,'坐骑','坐骑',1002,2),(310001,'钻戒',450,'钻石很久远，一颗就…','热门',1,1),(310002,'项链',320,'戴着它，我好像一下变得高贵了','热门',1,1),(310003,'香奈儿包包',300,'有钱就是任性，来一打','热门',1,1),(310004,'皇冠',200,'只有尊贵的人才配得上我','热门',1,1),(310005,'DIRO香水',150,'我是迪奥，不是奥迪哦','热门',1,1),(310006,'人头马',100,'壕们都是把我当啤酒喝','热门',1,1),(310007,'抱抱熊',70,'需要抱抱吗','热门',1,1),(310008,'便便',60,'阿拉蕾最喜欢的玩具','热门',1,1),(310009,'抱枕',50,'睡觉抱着我最舒服了','热门',1,1),(310010,'情书',40,'男女朋友都通用的情书哦','热门',1,1),(310011,'冰激凌',35,'快点吃掉我，我快化掉了','热门',1,1),(310012,'粉钻',35,'南非产正板粉钻','热门',1,1),(310013,'蛋糕',20,'吃多了会长胖的哦','热门',1,1),(310014,'香吻',15,'只献给最喜欢的人','热门',1,1),(310015,'喉宝',15,'喉宝助你好声音','热门',1,1),(310016,'鲜花',10,'请不要把我插在牛粪上','热门',1,1),(310017,'板砖',5,'任你再叼，一砖拍倒','热门',1,1),(310018,'棒棒糖',5,'棒棒，好棒哦','热门',1,1),(310019,'iphone6',100,'土豪金才符合我的气质呢','热门',1,1),(310020,'挖掘机',5,'挖掘机技术哪家强呢','热门',1,1),(320001,'鹊桥相会',1400,'这桥坚固吗','高级',2,1),(320002,'带字粉丝灯牌',600,'可不是一般的灯牌哦','高级',2,1),(320003,'烛光晚餐',2000,'只把最好的留给你','高级',2,1),(320004,'梦幻城堡',1500,'爱TA就送TA一座城堡','高级',2,1),(320005,'我爱你',1400,'对不起，我爱你','高级',2,1),(320006,'心雨',900,'心如雨下','高级',2,1),(320007,'烟花',600,'去年烟花特别多','高级',2,1),(320008,'丘比特之箭',500,'用它让主播爱上你吧','高级',2,1),(320009,'幸福摩天轮',1200,'幸福转转转','高级',2,1),(320010,'放飞气球',600,'飞屋环球必备','高级',2,1),(700001,'飞屏',100,'房间内的飞屏','飞屏',1003,1),(700002,'广播',200,'广播','广播',1004,1),(700003,'坐席',20,'坐席','坐席',1005,1);
