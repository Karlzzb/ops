...
USERNAME="root"
PASSWORD=""
MYSQL_CNF=/usr/local/webserver/mysql/my.cnf
MYSQL_SECURITIES="--user=${USERNAME} --password=${PASSWORD} --socket=/mysqldb/run/mysql.sock"

#Mysql Tools
MYSQL_ADMIN=/usr/local/webserver/mysql/bin/mysqladmin
MYSQL_CLI=/usr/local/webserver/mysql/bin/mysql
BACKUP_TOOL="/usr/bin/innobackupex --slave-info --safe-slave-backup --parallel=8"

#All Directories or Files
BACK_DIR=/backup/dbbackup
