...
error(){
  ...
  /usr/bin/zabbix_sender -z 172.16.30.16 -p 10051 -s caegi-backup-check -k mysql.backup  -o 172.16.31.54 > /dev/null 2>&1
  exit 1
}
...
#DB info
HOSTNAME=172.16.31.54
PORT=6980
USERNAME="dumpusr"
PASSWORD=""
MYSQL_CNF=/data/db/mysql6980/my.cnf
...
BACK_DIR=/backup/discuz-dbbackup
