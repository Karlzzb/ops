...
error(){
  ...
  /usr/bin/zabbix_sender -z 172.16.30.16 -p 10051 -s caegi-backup-check -k mysql.backup  -o 172.16.30.14 > /dev/null 2>&1
  exit 1
}
...
#DB info
HOSTNAME=172.16.30.14
PORT=3366
USERNAME="dumpusr"
PASSWORD=""
MYSQL_CNF=/data/db/mysql3366/my.cnf
...
#Limitations
FULL_BACKUP_GAP=86400 # Lifetime of the latest full backup in seconds
KEEP=7 # Number of full backups to keep
STARTED_AT=`date +%s`
